    ...
    <div class="navbar-main">
        <nav class="navbar" id="navbar">
            ...
            <div class="center" id="search-div">
                ...
                <button id="search-button" type="submit"><ion-icon id="search-icon" name="search-outline"></ion-icon></button>
            </div>
            <div class="right">
                <a class="navbar-button" href="login.php">
                    <label class="header-menu-text">login</label>
                    <ion-icon class="header-menu-icon" name="log-in-outline"></ion-icon>
                </a>
